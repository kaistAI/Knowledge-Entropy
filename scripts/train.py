...
from olmo.data import build_train_dataloader, build_original_train_dataloader
...
def main(cfg: TrainConfig) -> None:
    ...
    if cfg.data.dataset_path is not None:
        train_loader = build_train_dataloader(cfg)
    else:
        train_loader = build_original_train_dataloader(cfg)
